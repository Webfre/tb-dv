export const css_intro1 = {
  ...
  \`\`\`css
  /* Пример CSS-правила */
  h1 {                             /* Селектор (элемент <h1>) */
    color: #2c3e50;                /* Свойство: значение */
    text-align: center;            /* Свойство: значение */
    margin-bottom: 30px;           /* Свойство: значение */
  }
  \`\`\`
  
  В этом примере:
  - \`h1\` — селектор, выбирающий все заголовки первого уровня
  - \`color\`, \`text-align\`, \`margin-bottom\` — свойства
  - \`#2c3e50\`, \`center\`, \`30px\` — значения
