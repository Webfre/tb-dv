...
export const html_semantic_landing_5 = {
  id: "html_semantic_landing_5",
  module: "HTML",
  title: "Стихотворение: семантическая vs несемантическая разметка",
  topic: "Семантические теги",
  topicId: "html_semantics",
  sectionId: "html_sem_1",
  description:
    "Создайте HTML-страницу с коротким стихотворением в двух вариантах: сначала без семанических тегов, а затем — с использованием `<article>`, `<header>`, `<section>` и `<footer>`, чтобы показать преимущества семантики.",
  steps: [
    "Создайте файл `poem.html` с базовой структурой HTML.",
    "Добавьте на страницу заголовок `<h1>` — название задачи.",
    "Первая часть: оберните стих в `<div>` и внутри него вставьте один `<p>` с переносами строк через `<br>` (несемантически).",
    "Вторая часть: создайте `<article>`, внутри него `<header>` с заголовком `<h2>`, затем `<section>` с тем же стихом в `<p>`, а в конце `<footer>` с автором.",
    "Откройте в браузере и проанализируйте, как семантическая разметка помогает понять структуру содержимого.",
  ],
  difficulty: 2,
  resources: [
...
<head>
  <meta charset="UTF-8">
  <title>Стихотворение: семантика vs несемантика</title>
</head>
<body>
  <h1>Стихотворение: семантика vs несемантика</h1>

  <!-Несемантическая версия -->
  <div>
    <p>Мир любви, мир светлый,<br>
    Где цветы в зареве зари,<br>
    Где птиц поёт концерт,<br>
    И танцуют ветра в дали.</p>
  </div>
