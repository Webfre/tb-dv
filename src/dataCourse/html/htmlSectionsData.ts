...
import { html_best_1, html_best_2 } from "./html_best_practices";
import {
  html_el_1,
  html_el_2,
  html_el_3,
...
import { html_intro1, html_intro2, html_intro3 } from "./html_intro";
import { html_link_1, html_link_2, html_link_3 } from "./html_links_images";
import { html_meta_1, html_meta_2, html_meta_3 } from "./html_meta_head";
import { html_media_1, html_media_2 } from "./html_multimedia";
import { html_sem_1, html_sem_2, html_sem_3 } from "./html_semantics";
import {
  html_structure_1,
  html_structure_2,
  html_structure_3,
} from "./html_structure";
import { html_table_1, html_table_2, html_table_3 } from "./html_tables";
