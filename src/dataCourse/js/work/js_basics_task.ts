...
export const js_basics_task_9 = {
  ...
  steps: [
    "Создайте HTML-файл `index.html` и подключите `script.js` через тег `<script>` перед `</body>`.",
    "В файле `script.js` реализуйте следующий алгоритм:",
    "Сгенерируйте случайное число от 1 до 100 с помощью `Math.random()` и `Math.floor()`",
    "Создайте переменную-счетчик попыток (начинается с 1)",
    "В цикле `while` запрашивайте у пользователя число через `prompt`",
    "Преобразуйте ввод в число, проверьте корректность ввода",
    "Если число угадано — поздравьте пользователя и выведите количество попыток",
    "Если число не угадано — скажите 'больше' или 'меньше' и увеличьте счетчик попыток",
    "Добавьте возможность досрочного завершения игры (например, при вводе 'q')",
  ],
  difficulty: 4,
  solution: `<!DOCTYPE html>
<html lang="ru">
...
export const js_basics_task_18 = {
  id: "js_basics_task_18",
  module: "JavaScript",
  title: "Вывести числа от 1 до 10",
  sectionId: "js_basics_7",
  topic: "Основные конструкции и операции JavaScript",
  topicId: "js_basics",
  description: "Используя цикл, выведите в консоль числа от 1 до 10.",
  steps: [
    "Создайте цикл `for` с начальным значением 1.",
    "Проверьте условие, чтобы значение не превышало 10.",
    "На каждой итерации увеличивайте значение на 1.",
    "Выведите текущее значение в консоль.",
  ],
  difficulty: 1,
  solution: `<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8" />
  <title>Числа от 1 до 10</title>
</head>
<body>
  <h1>Числа от 1 до 10</h1>
  <script src="script.js"></script>
</body>
</html>`,
  codeExampleJS: `for (let i = 1; i <= 10; i++) {
  console.log(i);
}`,
};

export const js_basics_task_19 = {
  id: "js_basics_task_19",
  module: "JavaScript",
  ...
  topicId: "js_basics",
  description:
    "Попросите пользователя ввести число `N` и вычислите сумму всех чисел от 1 до `N` включительно.",
  steps: [
    "Запросите у пользователя число `N`.",
    "Создайте переменную для хранения суммы.",
    "Используйте цикл `for`, чтобы пройтись от 1 до `N`.",
    "На каждой итерации добавляйте текущее значение к сумме.",
    "После завершения цикла выведите итоговую сумму.",
  ],
  difficulty: 2,
  solution: `<!DOCTYPE html>
<html lang="ru">
<head>
  <meta charset="UTF-8" />
  <title>Сумма чисел от 1 до N</title>
</head>
<body>
  ...
  codeExampleJS: `const n = parseInt(prompt("Введите число N:"));
let sum = 0;
...
export const js_basics_task_20 = {
  id: "js_basics_task_20",
  module: "JavaScript",
  ...
  topicId: "js_basics",
  description:
    "Попросите пользователя ввести число `N` и вычислите его факториал (N!).",
  steps: [
    "Запросите у пользователя число `N`.",
    "Создайте переменную для хранения результата (начальное значение — 1).",
    "Используйте цикл `for`, чтобы умножать результат на каждое значение от 1 до `N`.",
...
export const js_basics_task_21 = {
  id: "js_basics_task_21",
  module: "JavaScript",
  ...
  topicId: "js_basics",
  description:
    "Попросите пользователя ввести количество чисел, которые необходимо вывести из последовательности Фибоначчи.",
  steps: [
    "Запросите у пользователя количество чисел `N`.",
    "Создайте две переменные для первых чисел последовательности: 0 и 1.",
    "Используйте цикл `for` для генерации последовательности.",
    "На каждой итерации вычисляйте следующее число как сумму двух предыдущих.",
    "Выведите результат в консоль или на экран.",
  ],
  difficulty: 4,
  solution: `<!DOCTYPE html>
<html lang="ru">
...
<body>
  ...
  codeExampleJS: `const n = parseInt(prompt("Сколько чисел Фибоначчи вывести?"));
let a = 0, b = 1, next;
